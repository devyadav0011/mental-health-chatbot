...
const RESPONSES = [
  ...
  "I can sense this weighs heavily on you ⚖️. Sometimes it helps to break things down - what's one small thing that might bring you comfort today?",
  "Your journey is uniquely yours 🗺️, and there's no 'right' way to feel. What would make you feel most supported right now?",
  ...
  "It's okay not to have all the answers right now 🤷‍♀️. What feels most important for you to explore or understand?",
];
